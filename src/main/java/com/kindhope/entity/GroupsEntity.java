 ...
 */
@Entity
@Table(name = "groups", schema = "kindhope", catalog = "")
public class GroupsEntity {
    ...
    private Collection<GroupPostEntity> groupPostsById;
    ...
    @OneToMany(mappedBy = "groupsByGroupId")
    public Collection<GroupPostEntity> getGroupPostsById() {
        return groupPostsById;
    }

    public void setGroupPostsById(Collection<GroupPostEntity> groupPostsById) {
