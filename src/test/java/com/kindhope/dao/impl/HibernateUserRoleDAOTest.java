 ...
 * @version 0.0.1
 */
public class HibernateUserRoleDAOTest extends AbstractDAOImplTest {
    ...
    public void read() throws Exception {
        assertNotNull(dao.read(UserRole.class, BigInteger.ONE));
    }

    @Test
    public void update() throws Exception {
        String email = "updated@test.com";
//        UserRole test = dao.findByEmail("test@tset.dom");
//        test.setEmail(email);
//        dao.update(test);
...
//        UserRole test = dao.findByEmail(email);
//        assertNotNull(test);
//        dao.delete(test);
//        assertNull(dao.findByEmail(email));
    }

    private UserRole getObject() {
        UserRole test = new UserRole();
//        test.setName("Test object");
//        test.setEmail("testUserRole@gmail.com");
