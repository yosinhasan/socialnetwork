 ...
 * @version 0.0.1
 */
public class HibernateCommentDAOTest extends AbstractDAOImplTest {
...
//        Comment test = dao.findByEmail("test@tset.dom");
//        test.setEmail(email);
//        dao.update(test);
...
//        Comment test = dao.findByEmail(email);
//        assertNotNull(test);
//        dao.delete(test);
...
//        test.setEmail("testComment@gmail.com");
