 ...
 * @version 0.0.1
 */
public class HibernateConnectionRequestDAOTest extends AbstractDAOImplTest {
    ...
    public void read() throws Exception {
        assertNotNull(dao.read(ConnectionRequest.class, BigInteger.ONE));
    }

    @Test
    public void update() throws Exception {
        String email = "updated@test.com";
//        ConnectionRequest test = dao.findByEmail("test@tset.dom");
//        test.setEmail(email);
//        dao.update(test);
...
//        ConnectionRequest test = dao.findByEmail(email);
//        assertNotNull(test);
//        dao.delete(test);
//        assertNull(dao.findByEmail(email));
    }

    private ConnectionRequest getObject() {
        ConnectionRequest test = new ConnectionRequest();
//        test.setName("Test object");
//        test.setEmail("testConnectionRequest@gmail.com");
